// WindowsTerminal.cpp : Defines the exported functions for the DLL application.
//
...
(JNIEnv *env, jobject) {
	...
	sprintf(str, "%d,%d", csbi.srWindow.Right - csbi.srWindow.Left, csbi.srWindow.Bottom - csbi.srWindow.Top);
