...
public class TestMetrics {
  ...
  public void testSecond() {
    Histogram h = METRICS.histogram(MetricRegistry.name(MonitorManager.class, "xxx"));
    h.update(100);
    h.update(200);
    h.update(300);
  ...
  public void testAggregation() {
    Histogram histogram1 = METRICS.histogram(MetricRegistry.name(MonitorManager.class, "query-1"));
    Histogram histogram2 = METRICS.histogram(MetricRegistry.name(MonitorManager.class, "query-2"));
    Histogram histogramCorrect = METRICS.histogram(MetricRegistry.name(MonitorManager.class, "query-correct"));
    Histogram histogramAggregate = METRICS.histogram(MetricRegistry.name(MonitorManager.class, "query-aggregate"));
    int count1 = 0;
    int count2 = 0;
