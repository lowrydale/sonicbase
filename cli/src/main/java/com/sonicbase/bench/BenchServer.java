...
public class BenchServer {
  ...
  static BenchmarkKafkaInsertPublish benchKafkaInsert = new BenchmarkKafkaInsertPublish();
  static BenchmarkKafkaDeletePublish benchKafkaDelete = new BenchmarkKafkaDeletePublish();
