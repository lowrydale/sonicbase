...
public class SonicBaseConnectionImpl implements SonicBaseConnection {
  ...
  @Override
  public SonicBasePreparedStatement prepareSonicBaseStatement(StoredProcedureContext context, String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
    return new SonicBasePreparedStatementImpl(context, proxy.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability));
  }
  ...
  @Override
  public SonicBasePreparedStatement prepareSonicBaseStatement(StoredProcedureContext context, String sql, int autoGeneratedKeys) throws SQLException {
    return new SonicBasePreparedStatementImpl(context, proxy.prepareStatement(sql, autoGeneratedKeys));
  }
  ...
  @Override
  public SonicBasePreparedStatement prepareSonicBaseStatement(StoredProcedureContext context, String sql, int[] columnIndexes) throws SQLException {
    return new SonicBasePreparedStatementImpl(context, proxy.prepareStatement(sql, columnIndexes));
  }
  ...
  @Override
  public SonicBasePreparedStatement prepareSonicBaseStatement(StoredProcedureContext context, String sql, String[] columnNames) throws SQLException {
    return new SonicBasePreparedStatementImpl(context, proxy.prepareStatement(sql, columnNames));
  }
