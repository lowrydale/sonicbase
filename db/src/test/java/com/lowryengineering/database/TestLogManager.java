...
//     }
    ...
    conn = DriverManager.getConnection("jdbc:dbproxy:127.0.0.1:9010", "user", "password");

    ((ConnectionProxy) conn).getDatabaseClient().createDatabase("test");

    conn.close();

    conn = DriverManager.getConnection("jdbc:dbproxy:127.0.0.1:9010/test", "user", "password");
