...
public class SchemaManagerTest {
  ...
  public void testCreateTableDropTable() throws IOException {
    ...
    cobj = new ComObject();
    cobj.put(ComObject.Tag.schemaBytes, schemaBytes);
    cobj.put(ComObject.Tag.tableName, "table1");
    cobj.put(ComObject.Tag.dbName, "test");
    cobj.put(ComObject.Tag.schemaVersion, 1000);
    cobj.put(ComObject.Tag.masterSlave, "slave");
  ...
  public void testCreateIndexDropIndex() throws IOException {
    ...
    cobj.put(ComObject.Tag.masterSlave, "master");
    cobj.put(ComObject.Tag.tableName, "table1");
    cobj.put(ComObject.Tag.indexName, "index1");
    cobj.put(ComObject.Tag.isUnique, true);

    cobj.put(ComObject.Tag.fieldsStr, "field1");
    ...
    assertTrue(common.getTables("test").get("table1").getIndexes().containsKey("index1"));
    ...
    assertFalse(common.getTables("test").get("table1").getIndexes().containsKey("index1"));
    ...
    cobj = new ComObject();
    cobj.put(ComObject.Tag.schemaBytes, schemaBytes2);
    cobj.put(ComObject.Tag.dbName, "test");
    cobj.put(ComObject.Tag.schemaVersion, server.getCommon().getSchemaVersion());
    cobj.put(ComObject.Tag.tableName, "table1");

    array = cobj.putArray(ComObject.Tag.indices, ComObject.Type.stringType);
    array.add("index1");
    cobj.put(ComObject.Tag.masterSlave, "slave");
  ...
  public void testAddDropColumn() throws IOException {
    ...
    cobj.put(ComObject.Tag.schemaVersion, 1000);
    cobj.put(ComObject.Tag.tableName, "table1");
    cobj.put(ComObject.Tag.columnName, "field2");
    cobj.put(ComObject.Tag.masterSlave, "master");
    ...
    cobj.put(ComObject.Tag.tableName, "table1");
    cobj.put(ComObject.Tag.columnName, "field2");
    cobj.put(ComObject.Tag.dataType, DataType.Type.BIGINT.name());
    cobj.put(ComObject.Tag.masterSlave, "master");
  ...
  public void testReconcileSchema() throws IOException {
    ...
    index.put(ComObject.Tag.schemaVersion, 1000);
    ...
    schemaRet.put(ComObject.Tag.indexSchema, indexSchema);
    ...
    common.getTables("test").get("table1").getIndexes().clear();
