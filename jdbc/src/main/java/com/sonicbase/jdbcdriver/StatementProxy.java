...
public class StatementProxy extends ParameterHandler implements java.sql.Statement, PreparedStatement {
  ...
  public ResultSet executeQuery() throws SQLException {
    try {
      ResultSetImpl ret = (ResultSetImpl) databaseClient.executeQuery(dbName, sql, parms, restrictToThisServer,
          procedureContext, disableStats);
  ...
  public int executeUpdate() throws SQLException {
    try {
      return (Integer) databaseClient.executeQuery(dbName,  sql, parms, restrictToThisServer, procedureContext,
          disableStats);
    }
    catch (Exception e) {
      throw new SQLException(e);
  ...
  public void doUpdate(Long sequence0, Long sequence1, Short sequence2, boolean disableStats) throws SQLException {
    databaseClient.executeQuery(dbName, sql, parms, sequence0, sequence1, sequence2, restrictToThisServer,
        procedureContext, disableStats);
  }
  ...
  public boolean execute() throws SQLException {
    try {
      int ret = (int)(Integer) databaseClient.executeQuery(dbName, sql, parms, restrictToThisServer,
          procedureContext, disableStats);
      return ret > 0;
    }
    catch (Exception e) {
  ...
  public boolean execute(String sql) throws SQLException {
    try {
      int ret = (Integer) databaseClient.executeQuery(dbName, sql, parms, restrictToThisServer,
          procedureContext, disableStats);
      return ret > 0;
    }
    catch (Exception e) {
  ...
  public void disableStats(boolean disable) {
    this.disableStats = disable;
  }
