...
public class ParameterHandlerTest {
  ...
  public void test() throws IOException, SQLException {
    ...
    assertEquals(new String((char[])ph.getValue(1)), "123");
    assertEquals(new String((char[])ph.getValue(2)), "123");
    assertEquals(new String((char[])ph.getValue(3)), "123");
    assertEquals(new String((char[])ph.getValue(4)), "123");
    assertEquals(ph.getValue(5), "123".getBytes("utf-8"));
    assertEquals(new String((char[])ph.getValue(6)), "123");
    assertEquals(new String((char[])ph.getValue(7)), "123");
    assertEquals(new String((char[])ph.getValue(8)), "123");
    ...
    assertEquals(new String((char[])ph.getValue(12)), "123");
    assertEquals(ph.getValue(13), "123".getBytes("utf-8"));
    assertEquals(new String((char[])ph.getValue(14)), "123");
    assertEquals(ph.getValue(15), "123".getBytes("utf-8"));
    assertEquals(new String((char[])ph.getValue(16)), "123");
