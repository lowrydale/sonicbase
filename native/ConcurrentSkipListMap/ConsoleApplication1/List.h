...
namespace skiplist { template<typename E>class ListIterator; }
...
namespace skiplist
{
	 ...
	 * <tt>beginIterator</tt>, <tt>add</tt>, <tt>remove</tt>, <tt>equals</tt>, and
	 ...
	 * implementation.<p>
	 *
	 * The <tt>List</tt> interface provides a special beginIterator, called a
	 * <tt>ListIterator</tt>, that allows element insertion and replacement, and
	 * bidirectional access in addition to the normal operations that the
	 * <tt>Iterator</tt> interface provides.  A method is provided to obtain a
	 * list beginIterator that starts at a specified position in the list.<p>
	 *
	...
	public:
		 ...
		 *         list does not permit null elements (optional)
		 */
		virtual int lastIndexOf(void *o) {
			return -1;
		}
		 ...
		 * sequence).
		 *
		 * @return a list beginIterator over the elements in this list (in proper
		 *         sequence)
		 */
		 ...
		 *        list beginIterator (by a call to {@link ListIterator#next next})
		 * @return a list beginIterator over the elements in this list (in proper
		 *         sequence), starting at the specified position in the list
		 * @throws IndexOutOfBoundsException if the index is out of range
